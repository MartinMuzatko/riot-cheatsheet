	...
	;(function (window, undefined) {
	  ...
	  */
	  ...
	  function insertTag(isVirtual, prevTag, newTag, root, tags, virtualFn, dom) {
	    ...
	    if (isVirtual) virtualFn(prevTag, root, newTag, dom.childNodes.length);else root.insertBefore(prevTag.root, newTag.root); // #1374 some browsers reset selected here
	  }
