	    ...
	    this.on('mount', function () {
	        ...
	        _this2.tags.markdown[_this2.tags.markdown.length - 1].on('mount', function () {
	            ...
	            for (var i = 0; i < shortcuts.length; i++) {
	                ...
	                shortcut.innerHTML = '<a href="#' + shortcut.id + '">#</a>' + shortcut.innerHTML;
